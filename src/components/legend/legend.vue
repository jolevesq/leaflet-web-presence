...
export default class LegendV extends Vue {
    ...
    @Watch('maps')
    onModif(newValue: any[], oldValue: any[]) {
        this.createLegend(newValue[0]);
    }

    createLegend(map: any) {
        // TODO: Use fake API in the meantime like jasonplaceholder
        const layer = (map as any).cpgLayers;
