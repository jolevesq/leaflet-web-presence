...
// Leaflet mouse position plugin: https://www.npmjs.com/package/leaflet-mouse-position
import 'leaflet-mouse-position';

@Component({
  name: 'cgp-mouse-position',
  components: {}
})
export default class MousePositionV extends Vue {
