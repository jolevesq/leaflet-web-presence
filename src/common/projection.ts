...
export class Projection {
     ...
     */
    static getProjection(epsg: string): object {
     ...
     * @returns {projection is object}
     */
    private static getLCCProjection(): object {
        ...
        // LCC projection
        const projection = new (L as any).Proj.CRS('EPSG:3978', '+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs', {
